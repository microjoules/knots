...
function setup() {
    ...
    renderer.setClearColor('lightgreen'); // blue background colour
    const scene = new THREE.Scene();

    // Set up the camera.
    const camera = new THREE.PerspectiveCamera(30.0, 1.0, 0.1, 10000.0); // view angle, aspect ratio, near, far
    camera.position.set(0.0, -150.0, 50.0);
